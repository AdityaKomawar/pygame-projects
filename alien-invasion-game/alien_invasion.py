...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        for row_no in range(no_of_rows):
            for alien_no in range(no_of_aliens):
                self._create_alien(row_no, alien_no)


    def _create_alien(self, row_no, alien_no):
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        ...
        alien.rect.y = alien_height + (2 * alien_height * row_no)
